...
$sql="UPDATE `tblbooks` SET `Qunatity` = Qunatity - 1 WHERE `tblbooks`.`id` = :bookid";
$query = $dbh->prepare($sql);
$retdate=Date('y:m:d', strtotime('+7 days'));
...
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->bindParam(':returndate',$retdate,PDO::PARAM_STR);
$query->execute();
